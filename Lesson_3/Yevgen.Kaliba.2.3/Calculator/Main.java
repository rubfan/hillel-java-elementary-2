...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            System.out.println("No command line arguments found, try manual input.");
        ...
        if (myOper.equalsIgnoreCase("Addiction")) {
            System.out.println("Result of addiction is: " + (a + b));
        } else if (myOper.equalsIgnoreCase("Subtraction")) {
            System.out.println("Result of subtraction is: " + (a - b));
        } else if (myOper.equalsIgnoreCase("Multiplication")) {
            System.out.println("Result of Multiplication is: " + (a * b));
        } else if (myOper.equalsIgnoreCase("Division")) {
            System.out.println("Result of Division is: " + (a / b));
        } else if (myOper.equalsIgnoreCase("Remainder")) {
            System.out.println("Remain from division is: " + (a % b));
        } else if (myOper.equalsIgnoreCase("Modulus")) {
            System.out.println("Modulus for a firs number is " + Math.abs(a) + " and modulus for second number is " + Math.abs(b) + ".");
        }
